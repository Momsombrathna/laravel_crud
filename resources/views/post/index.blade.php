...
<div class="row g-4 mt-1">
  ...
  <div class="col-lg-4">
      ...
      <div class="card shadow">
        ...
        <div class="card-body">
          <p class="btn btn-warning rounded-pill btn-sm">Category : {{ $row->category }}</p>
          <div class="card-title fw-bold text-primary h4">Tittle : {{ $row->title }}</div>
          <p class="text-secondary"><b>Content : </b>{{ Str::limit($row->content, 100) }}</p>
        </div>
      </div>
